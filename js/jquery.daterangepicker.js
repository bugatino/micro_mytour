...
(function(factory) {
    ...
    $.dateRangePickerLanguages = {
        ...
        "vi": //Vietnamese
        {
            ...
            "next-month": "Tháng",
            "next-year": "Năm",
            "less-than": "Ngày trả phòng và ngày nhận phòng không được lớn hơn %d ngày",
            "more-than": "Ngày trả phòng và ngày nhận phòng không được nhỏ hơn %d ngày",
            "default-more": "Vui lòng chọn khoảng thời gian lớn hơn %d ngày",
            "default-single": "Ngày nhận phòng",
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function init_datepicker() {
            ...
            box.find('.apply-btn').click(function() {
                closeDatePicker();
                var dateRange = getDateString(new Date(opt.start)) + translate('separator') + getDateString(new Date(opt.end));
        ...
        function checkAndSetDefaultValue() {
            ...
            var defaults = __default_string ? __default_string.split(translate('separator')) : '';
        ...
        function showSelectedInfo(forceValid, silent) {
            ...
            if (opt.start && opt.singleDate) {
                ...
                box.find('.apply-btn').removeClass('disabled');
                dateRange = getDateString(new Date(opt.start)) + translate('separator') + getDateString(new Date(opt.end));
                opt.setValue.call(selfDom, dateRange, getDateString(new Date(opt.start)), getDateString(new Date(opt.end)));
                if (initiated && !silent) {
                    $(self).trigger('datepicker-change', {
                        'value': dateRange,
        ...
        function createDom() {
            ...
            if (opt.showTopbar) {
                ...
                if (opt.customTopBar) {
                    ...
                    if (!opt.singleDate) {
                        html += ' <span class="separator-day">' + translate('separator') + '</span> <b class="end-day">...</b> <i class="selected-days">(<span class="selected-days-num">3</span> ' + translate('days') + ')</i>';
                    }
                    html += '</div>';
